// Jarvis — Windows desktop shell (WebView2).
//
...
// Run:    dist\Jarvis.exe  — or the no-build fallback start_jarvis.bat (Edge app mode).
...
internal static class Program
{
    ...
    private static void StartBackend(string repo)
    {
        ...
        {
            MessageBox.Show("Could not start the Jarvis backend:\n" + ex.Message +
